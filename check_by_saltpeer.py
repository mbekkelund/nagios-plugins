...
# -*- coding: UTF-8 -*-
#
# NOTE!!! For this to work, you will have to set up peers on your salt-master
# http://docs.saltstack.com/ref/peer.html
#
# Copyright (C) 2014 Morten Bekkelund
#
...
def execute_plugin(host,plugin,timeout):
    ...
    ret    = client.sminion.functions['publish.publish'](host,'cmd.run_all', plugin)
